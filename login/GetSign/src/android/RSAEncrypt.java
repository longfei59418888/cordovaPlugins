...
public class RSAEncrypt {
    ...
    RSAEncrypt(){
        //加载服务器公钥,用户加密传输的数据
        try {
           loadPublicKey(RSAEncrypt.DEFAULT_PUBLIC_KEY_SERVER);
        } catch (Exception e) {
            System.err.println(e.getMessage());
        }

        //加载客户端私钥，用户获取服务器token
        try {
    ...
    // 服务器公钥
    private static final String DEFAULT_PUBLIC_KEY_SERVER=
            "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDgYVYLKUfxi2+1+O+uLpI3tU66" + "\r" +
                    "m2k9o80AV5X9Brl1ZsyDAovKas66XHhI8bvdAK3YRtguqFXTWSQzfmpAtJy4qjzR" + "\r" +
                    "HMn+SRP//KmjpjuP+QCXhhYweCj98QoI4ArK3jAsZtEe+jB58A5vpS965i+cUale" + "\r" +
                    "FWNdYW1L+RuHmU2hvwIDAQAB" + "\r";
...
//            byte[] ciphers = RSAEncrypt.toBytes(RSAEncrypt.byteArrayToString(cipher));
//            //解密
//            byte[] plainText = rsaEncrypt.decrypt(rsaEncrypt.getPrivateKey(), ciphers);
